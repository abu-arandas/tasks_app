...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  bool isSupported(Locale locale) {
    ...
    return ['en', 'es', 'fr', 'de', 'zh', 'ja', 'ar'].contains(locale.languageCode);
  }
...
extension TranslateX on String {
  String get tr {
    // If we're in a context where we can get the AppLocalizations, use it
    if (Get.context != null) {
      return AppLocalizations.of(Get.context!).translate(this);
    }
